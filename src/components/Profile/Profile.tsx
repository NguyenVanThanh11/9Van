  ...
  return (
    <div className={`${resets.clapyResets} ${classes.root}`}>
      ...
      <div className={classes.form}>
        <InputField_SizeMdTypeDefaultDe
          ...
          text={{
            ...
            text: <div className={classes.text6}>Nhập họ </div>,
          }}
        />
        <InputField_SizeMdTypeDefaultDe
          ...
          text={{
            text: <div className={classes.text7}>Nhập email</div>,
          }}
        />
        <InputField_SizeMdTypeDefaultDe
          ...
          text={{
            label: <div className={classes.label2}>Trường</div>,
        ...
        <InputField_SizeMdTypeDefaultDe
          ...
          text={{
            label: <div className={classes.label3}>SĐT</div>,
      ...
      <InputField_SizeMdTypeDefaultDe
        ...
        text={{
          label: <div className={classes.label4}>Tên</div>,
      ...
      <div className={classes.inputWithLabel2}>
        <div className={classes.label5}>Số dư tài khoản</div>
