...
import classes from './BaiCuaToi.module.css';
...
/* @figmaId 6223:23481 */
export const BaiCuaToi: FC<Props> = memo(function BaiCuaToi(props = {}) {
  return (
    <div className={`${resets.clapyResets} ${classes.root}`}>
      ...
      <_TabButtonBase_CurrentTrueSize
        ...
        text={{
          text: <div className={classes.text7}>Đề của tôi</div>,
        }}
      />
      <_TabButtonBase_CurrentFalseSiz
        className={classes._TabButtonBase2}
        text={{
          text: <div className={classes.text8}>Kho đề chung</div>,
        }}
      />
      <div className={classes.table}>
        <div className={classes.content5}>
          ...
          <div className={classes.column4}>
            ...
            <div className={classes.tableCell49}>
          ...
          <div className={classes.column5}>
            ...
            <TableCell_StyleActionButtonsSu
              ...
              text={{
                ...
                text2: <div className={classes.text24}>Giao bài</div>,
              }}
            />
            <TableCell_StyleActionButtonsSu
              ...
              text={{
                ...
                text2: <div className={classes.text26}>Giao bài</div>,
              }}
            />
            <TableCell_StyleActionButtonsSu
              ...
              text={{
                ...
                text2: <div className={classes.text28}>Giao bài</div>,
              }}
            />
            <TableCell_StyleActionButtonsSu
              ...
              text={{
                ...
                text2: <div className={classes.text30}>Giao bài</div>,
              }}
            />
            <TableCell_StyleActionButtonsSu
              ...
              text={{
                ...
                text2: <div className={classes.text32}>Giao bài</div>,
              }}
            />
            <TableCell_StyleActionButtonsSu
              ...
              text={{
                ...
                text2: <div className={classes.text34}>Giao bài</div>,
              }}
            />
            <TableCell_StyleActionButtonsSu
              ...
              text={{
                ...
                text2: <div className={classes.text36}>Giao bài</div>,
              }}
            />
            <TableCell_StyleActionButtonsSu
              ...
              text={{
                ...
                text2: <div className={classes.text38}>Giao bài</div>,
              }}
            />
            <TableCell_StyleActionButtonsSu
              ...
              text={{
                ...
                text2: <div className={classes.text40}>Giao bài</div>,
              }}
            />
            <TableCell_StyleActionButtonsSu
              ...
              text={{
                ...
                text2: <div className={classes.text42}>Giao bài</div>,
              }}
            />
          </div>
        </div>
      ...
      <button className={classes.button}>
        <div className={classes.them}>Thêm</div>
      </button>
    </div>
  );
});
